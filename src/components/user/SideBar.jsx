import { Home, Music, Clock, Heart, User, Shield } from "lucide-react";
          ...
          {user?.roleName?.toLowerCase() === "admin" && (
            ...
            >
              <motion.div
                ...
                whileHover={{ rotate: 10 }}
              >
                <Shield className="w-6 h-6 text-gray-300 group-hover:text-cyan-400 transition-colors duration-300" />
              </motion.div>
              <span className="group-hover:translate-x-1 transition-transform duration-300">
                Quản lý Admin
              </span>
